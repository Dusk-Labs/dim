...
mod tests {
    ...
    use crate::tests::{post_episode_test_template, post_season_test_template, post_media_test_template};
    ...
    fn get_season_info() {
        run_test!(|client| {
            ...
            let mut resp = client.get("/api/v1/season/1/").dispatch();
            let resp_content = json!({
                "id": 1,
                "season_number": 2,
                "tvshowid": 1,
    ...
    fn delete_season() {
        run_test!(|client| {
            ...
            let resp = client.delete("/api/v1/season/1/").dispatch();
            assert_eq!(resp.status(), Status::NoContent);

            let resp = client.get("/api/v1/season/1/").dispatch();
    ...
    fn get_episode_info() {
        run_test!(|client| {
            ...
            let mut resp = client.get("/api/v1/episode/2/").dispatch();
            assert_eq!(resp.status(), Status::Ok);
    ...
    fn delete_episode_by_id() {
        run_test!(|client| {
            ...
            let resp = client
                .delete("/api/v1/episode/2/")
                .dispatch();

            assert_eq!(resp.status(), Status::Ok);

            let resp = client
                .get("/api/v1/episode/2/")
                .dispatch();
...
mod abnormal_url_params_tests {
    ...
    fn delete_episode_invalid_id() {
        run_test!(|client| {
            ...
            let resp = client
                .delete("/api/v1/episode/12312312312312")
                .dispatch();
