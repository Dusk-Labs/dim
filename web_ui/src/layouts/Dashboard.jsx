    ...
    render() {
        return (
            <main>
                ...
                <BannerPage>
                    {this.state.banners.map(({title, backdrop, synopsis, season, episode, duration, delta, banner_caption}, i) => <Banner key={i} src={backdrop} title={title} description={synopsis} season={season} episode={episode} duration={duration} delta={delta === undefined ? 0 : delta} banner_caption={banner_caption}/>)}
                </BannerPage>
                )}
